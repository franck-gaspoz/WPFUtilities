namespace WPFUtilities.Components.Services.Command
{
    ...
    /// </summary>
    public interface IServiceCommand<TParam1, TParam2, TParam3, TParam4> : IServiceCommand
    {
        /// <summary>
        ...
        void Execute(IServiceCommandExecuteContext context, TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4);
    }
}
