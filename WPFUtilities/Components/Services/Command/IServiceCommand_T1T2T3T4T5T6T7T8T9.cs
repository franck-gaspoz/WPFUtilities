namespace WPFUtilities.Components.Services.Command
{
    ...
    /// </summary>
    public interface IServiceCommand<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9> : IServiceCommand
    {
        /// <summary>
        ...
        void Execute(IServiceCommandExecuteContext context, TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4, TParam5 param5, TParam6 param6, TParam7 param7, TParam8 param8, TParam9 param9);
    }
}
