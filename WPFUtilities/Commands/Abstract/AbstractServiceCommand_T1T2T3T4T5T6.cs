...
namespace WPFUtilities.Commands.Abstract
{
    ...
    public abstract class AbstractServiceCommand
        <ImplType, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6> :
            AbstractServiceCommand<ImplType>,
            IServiceCommand<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>
            where ImplType : IServiceCommand<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>
    {
        /// <summary>
        ...
        {
            var array = ToValidParameterArray(context, parameter, 6);
        ...
        /// <inheritdoc/>
        public abstract void Execute(IServiceCommandExecuteContext context, TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4, TParam5 param5, TParam6 param6);
    }
}
