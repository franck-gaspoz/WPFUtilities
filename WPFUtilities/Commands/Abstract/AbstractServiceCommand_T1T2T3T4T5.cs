...
namespace WPFUtilities.Commands.Abstract
{
    ...
    public abstract class AbstractServiceCommand
        <ImplType, TParam1, TParam2, TParam3, TParam4, TParam5> :
            AbstractServiceCommand<ImplType>,
            IServiceCommand<TParam1, TParam2, TParam3, TParam4, TParam5>
            where ImplType : IServiceCommand<TParam1, TParam2, TParam3, TParam4, TParam5>
    {
        /// <summary>
        ...
        {
            var array = ToValidParameterArray(context, parameter, 5);
        ...
        /// <inheritdoc/>
        public abstract void Execute(IServiceCommandExecuteContext context, TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4, TParam5 param5);
    }
}
