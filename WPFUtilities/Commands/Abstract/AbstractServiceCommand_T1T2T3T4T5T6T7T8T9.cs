...
namespace WPFUtilities.Commands.Abstract
{
    ...
    public abstract class AbstractServiceCommand
        <ImplType, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9> :
            AbstractServiceCommand<ImplType>,
            IServiceCommand<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9>
            where ImplType : IServiceCommand<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9>
    {
        /// <summary>
        ...
        {
            var array = ToValidParameterArray(context, parameter, 9);
        ...
        /// <inheritdoc/>
        public abstract void Execute(IServiceCommandExecuteContext context, TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4, TParam5 param5, TParam6 param6, TParam7 param7, TParam8 param8, TParam9 param9);
    }
}
